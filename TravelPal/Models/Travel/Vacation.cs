...
namespace TravelPal.Models.Travel
{
    ...
    //    public Vacation(string destination, Country countries, int travellers, DateTime startDate, DateTime endDate, int travelDays, TripType type) : base(destination, countries, travellers, startDate, endDate, travelDays)
    //    {
    //        this.type = type;
    //    }
